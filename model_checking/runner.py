...
if __name__ == "__main__":
    ...
    flags.DEFINE_string("results_dir", None, required=True,
                        help="Directory containing all results generated by mcts.py, each of which represents a certain submodel.")
