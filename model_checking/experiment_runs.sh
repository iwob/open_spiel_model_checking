...
python3 mcts_v3.py --game mnk -m 5 -n 5 -k 4 --num_games 1 --quiet 1 --seed 42 --max_game_depth 5 --action_selector1 most2 --action_selector2 all --submodels_dir "results(v3)__mnk_5_5_4_all2" --encode_tree_in_spec

python3 mcts_v3.py --game mnk -m 5 -n 5 -k 4 --num_games 1 --quiet 1 --seed 42 --max_game_depth 5 --action_selector1 all  --action_selector2 most2 --submodels_dir "results(v3)__mnk_5_5_4_all1" --encode_tree_in_spec



# ----------------------

python3 mcts_v4.py --game mnk -m 5 -n 5 -k 4 --num_games 1 --quiet 1 --seed 42 --max_game_depth 7 --action_selector1 most2 --action_selector2 all --submodels_dir "results(v4)__mnk_5_5_4_all2"
